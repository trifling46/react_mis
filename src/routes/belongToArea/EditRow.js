...
class EditRow extends React.Component {
  ...
  render () {
    ...
    let loading = this.props.isEdit ? this.props.loading.effects['belongToArea/updateManageArea'] : this.props.loading.effects['belongToArea/addManageArea']
    ...
    <Modal
      ...
      footer={
        <Row>
          ...
          <Button onClick={this.debounceHandleOk} type='primary' className='z-query-btn' loading={loading}>提交</Button>
        </Row>
      }
    >
      <Form {...formItemLayout} >
